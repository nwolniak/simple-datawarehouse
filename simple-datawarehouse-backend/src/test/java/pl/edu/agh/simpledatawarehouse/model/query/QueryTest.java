...
class QueryTest {
    ...
    void testToStringColumnAndTable() {
        ...
        Query query = new Query(columns, table, null, null, null, null, null);
    ...
    void testToStringColumnAndTableAndOrderByStatement() {
        ...
        Query query = new Query(columns, table, null, null, null, null, orderByList);
        assertThat(query.toString()).isEqualTo("""
                                                       select column_name
                                                       from table_name
    ...
    void testToStringColumnAndTableAndWhereStatement() {
        ...
        Query query = new Query(columns, table, whereList, null, null, null, null);
        assertThat(query.toString()).isEqualTo("""
                                                       select column_name
                                                       from table_name
    ...
    void testToStringColumnAndTableAndJoinStatement() {
        ...
        Query query = new Query(columns, table, null, joinList, null, null, null);
        assertThat(query.toString()).isEqualTo("""
                                                       select column_name
                                                       from table_name
    ...
    void testToStringColumnAndTableAndGroupByStatement() {
        ...
        Query query = new Query(columns, table, null, null, groupByList, null, null);
        assertThat(query.toString()).isEqualTo("""
                                                       select column_name
                                                       from table_name
    ...
    void testToStringColumnAndTableAndGroupByStatementAndHavingStatement() {
        ...
        Query query = new Query(columns, table, null, null, groupByList, havingList, null);
        assertThat(query.toString()).isEqualTo("""
    ...
    void testThrowsExceptionWhenHavingStatementIsNotUsedWithGroupByStatement() {
        ...
        String table = "table_name";
        List<Condition> havingList = List.of(new Condition("column_name", ">", "value"));
        Query query = new Query(columns, table, null, null, null, havingList, null);
    ...
    void testToStringWithAllStatements() {
        ...
        List<Condition> havingList = List.of(new Condition("column_name", ">", "value"));
        List<OrderBy> orderByList = List.of(new OrderBy("column_name", true));
        Query query = new Query(columns, table, whereList, joinList, groupByList, havingList, orderByList);
        assertThat(query.toString()).isEqualTo("""
                                                       select sum(column_name)
                                                       from table_name
                                                       inner join other_table_name on
